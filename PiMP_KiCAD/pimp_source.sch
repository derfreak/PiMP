...
U 1 1 535ACFD8
P 2800 6050
F 0 "GND2" H 2880 6050 40  0000 L CNN
...
U 1 1 535ACFD9
P 3200 6050
F 0 "Remote1" H 3280 6050 40  0000 L CNN
...
U 1 1 535ACFDA
P 3600 6050
F 0 "Remote2" H 3680 6050 40  0000 L CNN
F 1 "CONN_1" H 3600 6105 30  0001 C CNN
...
U 1 1 535ACFDB
P 4000 6050
F 0 "NC1" H 4080 6050 40  0000 L CNN
F 1 "CONN_1" H 4000 6105 30  0001 C CNN
...
U 1 1 535ACFDC
P 4400 6050
F 0 "Base1" H 4480 6050 40  0000 L CNN
F 1 "CONN_1" H 4400 6105 30  0001 C CNN
...
U 1 1 535B82DF
P 4800 6050
F 0 "NO1" H 4880 6050 40  0000 L CNN
F 1 "CONN_1" H 4800 6105 30  0001 C CNN
...
U 1 1 535B82E0
P 5200 6050
F 0 "12Vperm1" H 5280 6050 40  0000 L CNN
F 1 "CONN_1" H 5200 6105 30  0001 C CNN
...
U 1 1 535B82E2
P 4900 2000
F 0 "K1" H 4550 2250 40  0000 C CNN
F 1 "FINDER-40.52" V 5745 2005 40  0000 C CNN
...
U 1 1 535B82E3
P 4900 3500
F 0 "K2" H 4550 3750 40  0000 C CNN
F 1 "FINDER-40.52" V 5745 3505 40  0000 C CNN
...
U 1 1 535B82E4
P 4200 2450
F 0 "D2" H 4200 2650 70  0000 C CNN
F 1 "DIODE" H 4150 2250 70  0000 C CNN
...
U 1 1 535B82E5
P 3400 2000
F 0 "D1" H 3400 2200 70  0000 C CNN
F 1 "DIODE" H 3350 1800 70  0000 C CNN
...
U 1 1 535B82E6
P 1400 2000
F 0 "C1" V 1500 2150 50  0000 C CNN
F 1 "220µF" V 1500 1850 50  0000 C CNN
...
F 1 "150K" V 1850 2250 50  0000 C CNN
...
F 1 "47K" V 2650 2500 50  0000 C CNN
...
U 1 1 535B82E9
P 1400 1550
F 0 "C2" V 1500 1700 50  0000 C CNN
F 1 "10nF" V 1500 1400 50  0000 C CNN
...
U 1 1 535ACFE8
P 2650 2700
F 0 "R2" V 2730 2700 50  0000 C CNN
F 1 "47K" V 2650 2700 50  0000 C CNN
...
Wire Wire Line
	5600 4100 3600 4100
$Comp
L OPEN_HARDWARE_1 GnuFDL1
U 1 1 535B82ED
P 900 7450
F 0 "GnuFDL1" H 900 7725 60  0001 C CNN
...
$EndComp
$Comp
L CONN_1 12Vswitched1
U 1 1 535ACFEB
P 2000 6050
F 0 "12Vswitched1" H 2080 6050 40  0000 L CNN
F 1 "CONN_1" H 2000 6105 30  0001 C CNN
...
U 1 1 535ACFEC
P 2400 6050
F 0 "GND1" H 2480 6050 40  0000 L CNN
...
+RaspPi-3.3V
Text GLabel 6000 1300 1    60   Output ~ 0
+RaspPi-27
$Comp
L NE555_REVB_07JUL2010 IC1
U 1 1 535B9141
P 2400 2050
F 0 "IC1" H 2400 2300 30  0000 C CNN
F 1 "NE555P" H 2400 1800 30  0000 C CNN
...
Text GLabel 2400 7000 3    60   Output ~ 0
+AMP-GND
Text GLabel 3200 7000 3    60   Output ~ 0
+AMP-12V
Text Notes 7050 1000 0    59   ~ 0
Description / Beschreibung:\n~                                                                                      \nEN:\nNE555P used as monostable flip-flop. Off-delay about 54 seconds. Time\nmodifyable with R1 and C1. Relay K1 used for switch off the Raspberry Pi\n(see /etc/systemd/system/multi-user.target.wants/gpio_poweroff.service).\nYou can use a opto coupler instead.\n\nDE:\nDer NE555P wird als monostabile Kippstufe benutzt. Die Abschaltverzögerung\nbeträgt etwa 54 Sekunden. Die Zeit kann mittels R1 und C1 veraendert werden.\nDas Relais K1 wird verwendet, um den Raspberry Pi auszuschalten\n(siehe /etc/systemd/system/multi-user.target.wants/gpio_poweroff.service).\nStatt einem Relaise kann auch ein Optokoppler verwendet werden.\n\n\nConnectors / Anschlüsse:\n~                                                                                      \n12Vswitched1:   switched from ignition switch / von Zündschloss geschaltet\nGND1...2:        ground / Masse\nRemote1...2:     off delayed 12VDC about K2 / Abfallverzögert 12VDC über K2\nNC1:            second switch contact from K2 (normally closed) /\n                 zweiter Schaltkontakt von K2 (Ruhezustand geschlossen)\nBase1:          second switch contact from K2 (Base) /\n                 zweiter Schaltkontakt von K2 (Basis)\nNO1:            second switch contact from K2 (normally open) /\n                 zweiter Schaltkontakt von K2 (Ruhezustand geöffnet)\n12Vperm1:      Permanent powered 12VDC / permanent Anliegende 12VDC
$Bitmap
Pos 10950 7100
Scale 1.000000
Data
